...
/**
 * GoogleIcon — Logo Google chính thức theo Google Brand Guidelines.
 * Dùng CSS vars --color-google-* để tránh hardcode. Giá trị hex vẫn là brand colors chính xác.
 */
...
export const ArrowUpIcon: React.FC<IconProps> = ({ size = 15, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const ArrowDownIcon: React.FC<IconProps> = ({ size = 15, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const PowerIcon: React.FC<IconProps> = ({ size = 24, className = '', ...props }) => (
  <svg
    width={size}
    height={size}
    viewBox="0 0 24 24"
...
export const AlertTriangleIcon: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} {...props}>
    <path
      d="M12 9v4m0 3.5v.5M10.3 3.86 1.82 18a2 2 0 0 0 1.71 3h16.94a2 2 0 0 0 1.71-3L13.7 3.86a2 2 0 0 0-3.4 0Z"
      stroke="currentColor"
      strokeWidth="2"
      strokeLinecap="round"
      strokeLinejoin="round"
...
export const XCircleIcon: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} {...props}>
...
export const InfoCircleIcon: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
  <svg width={size} height={size} viewBox="0 0 24 24" fill="none" className={className} {...props}>
...
export const HeartFilledIcon: React.FC<IconProps> = ({ size = 20, className = '', ...props }) => (
