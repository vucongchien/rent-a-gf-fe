...
const rawCompanions = [
  {
    ...
    introText: 'Mình thích cà phê, sách và những cuộc trò chuyện thú vị. Hãy cùng mình khám phá Sài Gòn nhé!',
  ...
  },
  {
    ...
    introText: 'Food blogger, yêu ẩm thực và du lịch. Cùng mình khám phá quán ngon Hà Nội nhé.',
  ...
  },
  {
    ...
    introText: 'Giáo viên yoga, thích thiên nhiên và sống chậm.',
  ...
  },
  {
    ...
    introText: 'Nhiếp ảnh gia tự do, thích chụp ảnh phong cảnh và portrait.',
    availableCities: ['TP.HCM'],
    averageRating: 4.9,
    totalReviews: 47,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích xem phim, đọc sách, và trà sữa. Cùng mình thư giãn cuối tuần nhé.',
    availableCities: ['TP.HCM'],
    averageRating: 4.5,
    totalReviews: 8,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Sinh viên năm cuối, năng động và hài hước.',
    availableCities: ['Hà Nội'],
    averageRating: 4.2,
    totalReviews: 3,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Đầu bếp nghiệp dư, thích nấu ăn và chia sẻ công thức.',
    availableCities: ['Đà Nẵng'],
    averageRating: 4.7,
    totalReviews: 15,
    voiceIntroUrl: null,
  ...
  // --- 20 COMPANIONS BỔ SUNG (comp-8 tới comp-27) ---
  {
    ...
    introText: 'Thích âm nhạc cổ điển và vẽ tranh. Rất vui được gặp các bạn.',
    availableCities: ['Hà Nội'],
    averageRating: 4.8,
    totalReviews: 9,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích leo núi, dã ngoại và chụp ảnh thiên nhiên.',
    availableCities: ['Đà Nẵng'],
    averageRating: 4.5,
    totalReviews: 14,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Yêu động vật, đặc biệt là mèo. Rất thích trò chuyện.',
    availableCities: ['TP.HCM'],
    averageRating: 4.9,
    totalReviews: 30,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích đọc sách tâm lý học và đi dạo buổi tối.',
    availableCities: ['Hà Nội'],
    averageRating: 4.7,
    totalReviews: 12,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Yêu thích thời trang, shopping và làm đẹp. Cùng đi mua sắm nhé!',
    availableCities: ['TP.HCM'],
    averageRating: 4.6,
    totalReviews: 5,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Giáo viên dạy tiếng Anh, cởi mở và thích kết bạn mới.',
    availableCities: ['Đà Nẵng'],
    averageRating: 4.9,
    totalReviews: 22,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Vui vẻ, năng động, thích các hoạt động ngoài trời.',
    availableCities: ['Hà Nội'],
    averageRating: 4.4,
    totalReviews: 8,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Yêu thích làm bánh ngọt, chụp ảnh và cà phê.',
    availableCities: ['TP.HCM'],
    averageRating: 4.8,
    totalReviews: 19,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích thơ ca, nhạc nhẹ và cuộc sống bình yên.',
    availableCities: ['Đà Nẵng'],
    averageRating: 4.7,
    totalReviews: 7,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Nhiệt huyết, thích chia sẻ về khởi nghiệp và kinh doanh.',
    availableCities: ['TP.HCM'],
    averageRating: 4.3,
    totalReviews: 4,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích ca hát, đàn guitar và nói chuyện hài hước.',
    availableCities: ['Hà Nội'],
    averageRating: 4.9,
    totalReviews: 26,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích tập gym, ăn healthy và chăm sóc sức khỏe.',
    availableCities: ['Đà Nẵng'],
    averageRating: 4.6,
    totalReviews: 15,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích chụp hình retro, đi cafe vintage và ngắm phố.',
    availableCities: ['TP.HCM'],
    averageRating: 4.8,
    totalReviews: 11,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Rất thích nấu đồ ăn Hàn Quốc và làm bánh.',
    availableCities: ['Hà Nội'],
    averageRating: 4.7,
    totalReviews: 13,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích hoa, làm vườn và cắm hoa nghệ thuật.',
    availableCities: ['Đà Nẵng'],
    averageRating: 4.5,
    totalReviews: 6,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thiết kế đồ họa, thích game indie và anime.',
    availableCities: ['TP.HCM'],
    averageRating: 4.9,
    totalReviews: 18,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Yêu thích trà đạo, cờ vây và tìm hiểu lịch sử.',
    availableCities: ['Hà Nội'],
    averageRating: 4.8,
    totalReviews: 14,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Thích tập Pilates và tìm hiểu về tarot.',
    availableCities: ['Đà Nẵng'],
    averageRating: 4.6,
    totalReviews: 9,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Yêu thích piano và giao tiếp đa văn hóa.',
    availableCities: ['TP.HCM'],
    averageRating: 4.9,
    totalReviews: 21,
    voiceIntroUrl: null,
  ...
  },
  {
    ...
    introText: 'Nhân viên kế toán, trầm tính nhưng rất biết lắng nghe.',
    availableCities: ['TP.HCM'],
    averageRating: 4.7,
    totalReviews: 10,
    voiceIntroUrl: null,
